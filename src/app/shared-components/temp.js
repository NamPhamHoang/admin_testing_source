  ...
  return (
    <div>
      ...
      <div id="wrapper">
        {/* Sidebar */}
        <ul
          className="navbar-nav bg-custom-primary sidebar sidebar-dark accordion"
          id="accordionSidebar"
        >
          {/* Sidebar - Brand */}
          <a
            className="sidebar-brand d-flex align-items-center justify-content-center logo-bg"
            href="index.html"
          >
            <img
              src="img/reliably_me_logo.png"
              alt="Logo"
              style={{ width: "170px" }}
              className="img-fluid"
            />
          ...
          <div id="content">
            ...
            <div className="container-fluid">
              ...
              <div className="card shadow mb-4">
                ...
                >
                  <h5 className="m-0 text-center text-white">
                    My Promises <span className="small">(76)</span>
                  </h5>
                </a>
                ...
                <div className="card-body" id="collapseCardAction1">
                  <div className="table-responsive">
                    <table
                      className="table table-bordered table-striped table-hover small nowrap badge-priority"
                      width="100%"
                      cellSpacing={0}
                    >
              ...
              <div className="card shadow mb-4">
                ...
                >
                  <h5 className="m-0 text-center text-white">
                    Pending Invitation <span className="small">(34)</span>
                  </h5>
                </a>
                {/* Card Content - Collapse */}
